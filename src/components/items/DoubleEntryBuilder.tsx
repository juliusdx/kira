...
export function DoubleEntryBuilder({
  ...
  // A double entry is always a multi-part answer (two accounts and two
  // amounts), so it never auto-submits — picking the second account must not
  // commit before the first can be changed.
